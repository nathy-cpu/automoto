...
class JobScraper:
    ...
    def get_recent_jobs(self, country: str, keywords: Optional[str] = None, max_pages: int = 5) -> List[Dict]:
...
def scrape_jobs(websites: List[str], country: str, keywords: Optional[str] = None) -> List[Dict]:
